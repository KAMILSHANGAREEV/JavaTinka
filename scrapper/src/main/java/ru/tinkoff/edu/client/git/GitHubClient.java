package ru.tinkoff.edu.client.git;

import org.springframework.web.reactive.function.client.WebClient;
import ru.tinkoff.edu.controller.dto.RepositoryResponse;
...
public class GitHubClient {
    ...
    public RepositoryResponse getRepoInfo(String username, String repo) {
        return WEB_CLIENT.get().uri("{username}/{repo}", username, repo).retrieve().bodyToMono(RepositoryResponse.class).timeout(Duration.ofSeconds(10)).block();
    }
}
